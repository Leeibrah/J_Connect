...
<?php $bases_assets="assets/themes/flat/admin/template_content/"; ?>
    ...
    <script src='<?=asset("{$bases_assets}js/jquery.nicescroll.js")?>' type="text/javascript"></script>
    <script src='<?=asset("{$bases_assets}js/jquery.sparkline.js")?>' type="text/javascript"></script>
    <script src='<?=asset("{$bases_assets}assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js")?>'></script>
    <script src='<?=asset("{$bases_assets}js/owl.carousel.js")?>' ></script>
